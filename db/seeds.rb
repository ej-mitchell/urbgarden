...
# 30.times do
#   Event.create(name: Faker::Hipster.sentence(3), start_time: "09-09-09 10:10:10", end_time: "10-10-10 11:11:00", event_url: "https://github.com/stympy/faker", address: Faker::Address.street_address, city: Faker::StarTrek.location, state: Faker::Address.state_abbr, map_url: 'https://goo.gl/maps/7DNC7RqiEgP2' )
# end

# @events = Event.all
# @events.each do |event|
#   event.description = "I am an event description. I will contain information about this event."
#   event.save
# end
